...
model_inception3.compile(optimizer=opt,loss='categorical_crossentropy',metrics=['accuracy']) 
...
step_size_train=32 
print(step_size_train)
history = model_inception3.fit_generator(generator=train_generator_MPRAGE_3Cat, validation_data=val_generator_MPRAGE_3Cat,
...
loss, acc = model_inception3.evaluate_generator(test_generator_MPRAGE_3Cat, steps=10, verbose=1)
...
# Get predictions
y_pred = model_inception3.predict_generator(test_generator_MPRAGE_3Cat, steps=1, verbose=0)
